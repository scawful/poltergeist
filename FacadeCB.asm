...
Sprite_Facade_Prep:
{
    ...
    LDA $7EF374 : AND.b #$01 : BEQ .noPendant3
        STZ $0DD0, X
...
Sprite_Facade_Main:
{
	...
	dw waitbeforespawn ; 0x00
	dw spawning        ; 0x01
	dw messagedisplay  ; 0x02
	dw mainblinking    ; 0x03
	dw despawning      ; 0x04
	dw respawning      ; 0x05
	dw holespawning    ; 0x06
	dw holemain        ; 0x07
	dw holedespawn     ; 0x08
	dw Dying           ; 0x09
	dw Maiden          ; 0x0A
	dw MaidenDisappear ; 0x0B
}
