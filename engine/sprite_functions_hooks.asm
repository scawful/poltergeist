;set the position of the sprite spawned to current sprite
org $09AE64
...
;Required to make the sprite move with the speeds values
org $1D808C
Sprite_MoveLong:
