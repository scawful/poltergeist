...
; Sprite Properties
;==============================================================================
!SPRID              = $3D; The sprite ID you are overwriting (HEX)
...
%Set_Sprite_Properties(Sprite_Clown_Prep, Sprite_Clown_Long);
;==================================================================================================
...
JSR Sprite_Clown_Draw ; Call the draw code
JSL Sprite_CheckActive   ; Check if game is not paused
BCC .SpriteIsNotActive   ; Skip Main code is sprite is innactive

JSR Sprite_Clown_Main ; Call the main sprite code
