...
!Damage             = 5   ; (08 is a whole heart), 04 is half heart
...
{  
    ...
    LDA.w SprXSpeed, X : BEQ .nodiagonal 
        LDA.w SprYSpeed, X : BEQ .nodiagonal 
            ...
            LDA.w SprXSpeed, X : BPL .diagoxspeedpositive
...
Sprite_DarkLink_Draw:
{
    ...
    LDA.w SprMiscF, X : BNE .justshadow2
        LDA $0DC0, X : CLC : ADC $0D90, X : TAY;Animation Frame
