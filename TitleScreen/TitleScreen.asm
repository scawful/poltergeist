...
org $0CC27E ;disables BG 3 durring opening sequence as it is not used
    db #$11

org $0CC51D ;disables BG 3 durring opening sequence as it is not used
    db #$01

org $0CC2AE ;applies the tile map after the orignial is placed in 
    JSL Main2

org $0CEE39 ;at the begining of the history cut scene reset the bg address
    JSL Reset1 

org $0CCDE2 ;once the select screen appears, reset the bg adress
    JSL Reset2
...
Reset1:
{
    ...
    LDA.b #$00 : STA $35 ;reset first main2 check
...
TitlePalette:
    dw $0000, $0421, $1CE7, $294A, $318C, $14E9, $21B1, $110B
    dw $196E, $10C7, $14A4, $1CA6, $0C43, $1064, $0C77, $000A
    dw $0000, $0C77, $000A
